...
$footer_question = get_theme_mod('footer_question');
...
$pinterest = get_theme_mod('footer_pinterest_link');
$payment_image = get_theme_mod('payment_image');
?>
...
<footer class="footer footer-2">
                ...
                <div class="col-sm-12 col-lg-6">
                    <div class="widget widget-about">
                        ...
                        <img src="<?php echo esc_url($footer_logo); ?>"
                            class="footer-logo" alt="<?php bloginfo('name') ?>" width="105" height="25">
                            <?php endif; ?>
                        ...
                        <div class="widget-about-info">
                            <div class="row">
                                <div class="col-sm-6 col-md-4">
                                    <span class="widget-about-title"><?php echo esc_html($footer_question); ?></span>
                                ...
                                <div class="col-sm-6 col-md-8">
                                    ...
                                    <figure class="footer-payments">
                                        ...
                                        <img src="<?php echo esc_url($payment_image); ?>"
    ...
    <div class="footer-bottom">
        <div class="container">
            <p class="footer-copyright"><?php echo esc_html($footer_copyright); ?></p><!-- End .footer-copyright -->
            ...
            <div class="social-icons social-icons-color">
                ...
                <a href="<?php echo esc_url($facebook); ?>" class="social-icon social-facebook" title="Facebook" target="_blank"><i
                        class="icon-facebook-f"></i></a>
                <a href="<?php echo esc_url($twitter); ?>" class="social-icon social-twitter" title="Twitter" target="_blank"><i
                        class="icon-twitter"></i></a>
                <a href="<?php echo esc_url($instagram); ?>" class="social-icon social-instagram" title="Instagram" target="_blank"><i
                        class="icon-instagram"></i></a>
                <a href="<?php echo esc_url($youtube); ?>" class="social-icon social-youtube" title="Youtube" target="_blank"><i
                        class="icon-youtube"></i></a>
                <a href="<?php echo esc_url($pinterest); ?>" class="social-icon social-pinterest" title="Pinterest" target="_blank"><i
...
<script src="<?php echo get_template_directory_uri(); ?>/assets/js/wNumb.js"></script>
<script src="<?php echo get_template_directory_uri(); ?>/assets/js/nouislider.min.js"></script>

<!-- Main JS File -->
<script src="<?php echo get_template_directory_uri(); ?>/assets/js/main.js"></script>
<script src="<?php echo get_template_directory_uri(); ?>/assets/js/demos/demo-13.js"></script>
<?php wp_footer(); ?>
</body>


<!-- /index-13.html  22 Nov 2019 09:59:31 GMT -->
